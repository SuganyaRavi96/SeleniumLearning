...
public class CreateAccount {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    driver.findElementByName("groupNameLocal").sendKeys("Demo");
	    driver.findElementById("officeSiteName").sendKeys("OfficeName");
	    driver.findElementById("annualRevenue").sendKeys("100000");
