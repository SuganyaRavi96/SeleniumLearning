...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElementByXPath("//input[@name='emailAddress']").sendKeys("priya@gmail.com");
		...
		System.out.println(driver.getTitle());
		  ...
		  if(str.equals(ele)) {
			  System.out.println("duplication operation is performed");
		  }else {
			  System.out.println("duplicate validition failed");
		  }
		  driver.close();
	}
